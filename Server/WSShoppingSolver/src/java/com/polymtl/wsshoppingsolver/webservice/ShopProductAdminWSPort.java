...
import com.polymtl.wsshoppingsolver.webservice_client1.ShopProductAdminWS;
...
public class ShopProductAdminWSPort {
    ...
    private ShopProductAdminWS getPort() {
        try {
            // Call Web Service Operation
            com.polymtl.wsshoppingsolver.webservice_client1.ShopProductAdminWS_Service service = new com.polymtl.wsshoppingsolver.webservice_client1.ShopProductAdminWS_Service();
